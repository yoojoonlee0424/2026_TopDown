...
public class RandomWeightedTile : Tile
{
    ...
    public override void GetTileData(Vector3Int position, ITilemap tilemap, ref TileData tileData)
    {
        ...
        float randomWeight = (float)rand.NextDouble() * cumulativeWeight;
...
#if UNITY_EDITOR
[CustomEditor(typeof(RandomWeightedTile))]
public class WeightedRandomTileEditor : Editor
{
    private SerializedProperty m_Color;
    private SerializedProperty m_ColliderType;

    private RandomWeightedTile Tile
    {
        get { return target as RandomWeightedTile; }
    }
